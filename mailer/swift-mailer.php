...
class Email
{
    ...
    public function __construct($server, $port = 25, $connectionTimeout = 30, $responseTimeout = 8, $hostname = null)
    {
        ...
        //$this->headers['X-Facebook-Important'] = '{'.Randstring(8).'}- Notify {'.Randstring2(19).'} ' ;
		    //$this->headers['Message-ID'] = '<'.Randstring2(35).''.Randstring(40).'=====@inside.apple.com>';
		    //$this->headers['Kontol-ID'] = ''.Randstring(12).'';
        $this->headers['Message-ID'] = '<05c7269a-4ad4-47a8-a745-cf83ca507290@xtgap4s7mta1245.xt.local>';
        //$this->headers['Subject'] = RandString(29);
        //$this->headers['Retur-Path'] = 'test';
        //$this->headers['Return-Path'] = 'test';
    ...
    public function send()
    {
        ...
        $this->headers['Return-Path'] = 'msa@communication.microsoft.com';
